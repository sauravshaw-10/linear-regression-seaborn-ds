...
sns.displot(df['Length of Membership'])
...
# Every 1 unit increase in Avg. Session length increases yearly spends by ~$26 keeping all other coefficients same.

# **Do you think the company should focus more on their mobile app or on their website?**

# Should focus more on Mobile App, as it brings more incremental revenue.
